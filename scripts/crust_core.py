...
omega_b_s = dist.VectorField(coords, name="omega_b_s", bases=basis_core.ball) # Superfluid vorticity

u_b_ns = u_b_n - u_b_s
omega_b_s = Curl(u_b_s) + 2 * ez_b
omega_unit_b = omega_b_s / 2
F_mf_b = B * (Cross(omega_unit_b, Cross(omega_b_s, u_b_ns))) + Bprime * Cross(omega_b_s, u_b_ns)
